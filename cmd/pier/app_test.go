...
func TestCloudErrorUsesBaseAWSLoginClassifier(t *testing.T) {
	code, message := appCloudError(
		"list_failed",
		errors.New("aws ec2 describe-instances: Your session has expired. Please reauthenticate using 'aws login'."),
	)
